...
func TestNewMemoryStoreAddPrediction(t *testing.T) {
...
func TestNewMemoryStoreUpdatePrediction(t *testing.T) {
	store := NewMemoryStore()
	defer store.Close()
	store.Clean()
	assert.NotNil(t, store, "Should not be nil")
...
func TestNewMemoryStoreDeletePrediction(t *testing.T) {
	store := NewMemoryStore()
	defer store.Close()
	store.Clean()
	assert.NotNil(t, store, "Should not be nil")
...
func TestNewMemoryStoreGetPredictions(t *testing.T) {
	fmt.Printf("Start\n")
	store := NewMemoryStore()
	defer store.Close()
	store.Clean()
