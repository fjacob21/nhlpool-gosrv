...
func TestNewMemoryStoreAddMatchup(t *testing.T) {
...
func TestNewMemoryStoreUpdateMatchup(t *testing.T) {
	store := NewMemoryStore()
	defer store.Close()
	store.Clean()
	assert.NotNil(t, store, "Should not be nil")
...
func TestNewMemoryStoreDeleteMatchup(t *testing.T) {
	store := NewMemoryStore()
	defer store.Close()
	store.Clean()
	assert.NotNil(t, store, "Should not be nil")
...
func TestNewMemoryStoreGetMatchups(t *testing.T) {
	store := NewMemoryStore()
	defer store.Close()
	store.Clean()
	assert.NotNil(t, store, "Should not be nil")
