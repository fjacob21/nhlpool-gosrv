...
func TestNewMemoryStoreAddWinner(t *testing.T) {
...
func TestNewMemoryStoreUpdateWinner(t *testing.T) {
	store := NewMemoryStore()
	defer store.Close()
	store.Clean()
	assert.NotNil(t, store, "Should not be nil")
...
func TestNewMemoryStoreDeleteWinner(t *testing.T) {
	store := NewMemoryStore()
	defer store.Close()
	store.Clean()
	assert.NotNil(t, store, "Should not be nil")
...
func TestNewMemoryStoreGetWinners(t *testing.T) {
	fmt.Printf("Start\n")
	store := NewMemoryStore()
	defer store.Close()
	store.Clean()
