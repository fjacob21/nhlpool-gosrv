...
func TestNewMemoryStoreAddGame(t *testing.T) {
...
func TestNewMemoryStoreUpdateGame(t *testing.T) {
	store := NewMemoryStore()
	defer store.Close()
	store.Clean()
	assert.NotNil(t, store, "Should not be nil")
...
func TestNewMemoryStoreDeleteGame(t *testing.T) {
	store := NewMemoryStore()
	defer store.Close()
	store.Clean()
	assert.NotNil(t, store, "Should not be nil")
...
func TestNewMemoryStoreGetGames(t *testing.T) {
	store := NewMemoryStore()
	defer store.Close()
	store.Clean()
	assert.NotNil(t, store, "Should not be nil")
